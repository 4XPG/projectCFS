...
using Random = UnityEngine.Random;
    ...
    public class AeroplaneAI : MonoBehaviour
    {
        ...
        private AeroplanePhysics m_AeroplaneController;  // The aeroplane controller that is used to move the plane
        ...
        private void Awake()
        {
            ...
            m_AeroplaneController = GetComponent<AeroplanePhysics>();
