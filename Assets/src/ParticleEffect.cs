...
using UnityEngine;
    ...
    public class ParticleEffect : MonoBehaviour
    {
        ...
        private AeroplanePhysics m_Jet; // The jet that the particle effect is attached to
        ...
        private AeroplanePhysics FindAeroplaneParent()
        {
            ...
            while (t != null)
            {
                var aero = t.GetComponent<AeroplanePhysics>();
                if (aero == null)
                {
                    // try next parent
                    t = t.parent;
