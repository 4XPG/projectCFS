...
public class Radar1 : MonoBehaviour
{
	...
	public enum RadarLocations : int {TopLeft, TopCenter, TopRight, BottomLeft, BottomCenter, BottomRight, Left, Center, Right, Custom, MFDLeft, MFDRight};
	...
	void setRadarLocation()
	{
		...
		else if(radarLocation == RadarLocations.MFDLeft)
		{
			_radarCenter = new Vector2(MFDLeftPos.localPosition.x /2, MFDLeftPos.localPosition.y /2);
			_radarCenter = transform.InverseTransformPoint(transform.position);
		}	
		else if(radarLocation == RadarLocations.MFDRight)
		{
			_radarCenter = new Vector2(MFDRightPos.localPosition.x /2, MFDRightPos.localPosition.y /2);
		}					
	} 
