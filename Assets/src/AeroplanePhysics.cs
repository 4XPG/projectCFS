...
using UnityEngine;
    ...
    public class AeroplanePhysics : MonoBehaviour
    {
        ...
        [SerializeField] private float m_AutoTurnPitch = 0.2f;        // How much the aeroplane automatically pitches when in a banked turn.
        ...
        [SerializeField] private float initialThrottle = 0.5f;
        ...
        public float AoA {get; private set;}		// angle of attack value, limits pitch angle
        public float MaxAoA;
        ...
        private void Start()
        {
            ...
            GetComponent<Rigidbody>().maxAngularVelocity = 3f;
        ...
        private void CalculateRollAndPitchAngles()
        {
            ...
            /*AoA = Vector3.Dot(Vector3.Normalize(transform.up), Vector3.up);
    // Don't add force when the rotation of the dragon is more that 45
        ...
        public void getClimbRate(){
        	var localVelocity = transform.InverseTransformDirection(m_Rigidbody.velocity);
        	climbRate = Mathf.Max(0, localVelocity.y);
        }
